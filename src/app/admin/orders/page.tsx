    ...
    return (
        <AdminGuard>
            <div className="space-y-6 animate-in fade-in duration-500">
                <div>
                    <h1 className="text-3xl font-black text-gray-900 dark:text-white">Historial de Pedidos</h1>
                    <p className="text-gray-500 mt-1">Monitorea todas las transacciones generadas desde la web.</p>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Ventas del mes actual</p>
                        </CardContent>
                    </Card>
                </div>
