      ...
      <div className="max-w-xl w-full z-10 text-center space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-1000">
        ...
        <div className="grid grid-cols-1 gap-4 pt-6">
          <Link href="/">
            <Button
              size="lg"
              className="w-full bg-primary hover:bg-white hover:text-black transition-all duration-500 font-black text-xl h-16 rounded-none group"
            >
          ...
          <Link href="/#featured">
            <Button
              size="lg"
              variant="outline"
              className="w-full border-white/20 hover:bg-white/10 h-16 font-bold tracking-widest uppercase"
            >
